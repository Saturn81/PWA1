...
(function(){
   ...
   var warrior1 =["Spider-Man",25,100];   //array used to for name of superhero, damage, and total beginning health
   var warrior2=["Batman",25,100];          //array used to for name of superhero, damage, and total beginning health
...
alert(warrior1[0]+":"+warrior1[2]+" *START* "+warrior2[0]+":"+warrior2[2]);   //alert to show the display of the Player and their health
    ...
    for (var i=0; i <10; i++){   //to change the number of rounds
        ...
        warrior1[2]-=f1;    //this is how damage gets decucted for player 1
        warrior2[2]-=f2;    //this is how damage gets decucted for player 2
