...
STUDENT ACTIVITY
	...
	4. 	Describe the possible answer for this: /^[a-zA-Z\^\-\.]+$/
		...
		Answer:   The starting word in the String can be lowercase or uppercase,
	...
	5.	Combining character sets can create sequences of matches.
		...
		Answer:       and start must be lower or upercase.  the ending must have a 0-9 in it it.
...
//var clean2 = str.replace(/(\w[-._\w]*\w@\w[-._\w]*\w\.\w{2,3})/g,"XXX@XXX.com");
...
var testEmail =/(\w[-._\w]*\w@\w[-._\w]*\w\.\w{2,3})/;

    var juniperRaising= new RegExp(testEmail);
    var str2="My email that is so simple is this one, jsuika@fullsail.com.";

    console.log(juniperRaising.test(str2));
    console.log(str2.search(juniperRaising));

    var hope=str2.replace(juniperRaising,"sobiz@aol.com");
...
//console.log(document.getElementById("tagbox").innerHTML=Math.random());
    ...
    console.log(document.getElementById("tagbox").innerHTML="The spider bites and the bug survives");
    ...
    ****************************************************************************/
    ...
    console.log(Math.random()*100000+5000);
    console.log(Math.floor(Math.random()*10000+1000));

    var num3=Math.random()*100+10;
